...
clock_image = pygame.transform.scale(
    pygame.image.load(r"C:\Users\Lenovo\Downloads\clock.png").convert_alpha(),
    (WIDTH, HEIGHT)
)
min_hand_image = pygame.image.load(r"C:\Users\Lenovo\Downloads\min_hand.png").convert_alpha()
sec_hand_image = pygame.image.load(r"C:\Users\Lenovo\Downloads\sec_hand.png").convert_alpha()
